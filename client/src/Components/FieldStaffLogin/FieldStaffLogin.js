...
const FieldStaffLogin = ({ setUserState }) => {
  ...
  const changeHandler = (e) => {
    ...
    if (name === "userType" && value === "admin") {
      navigate("/AdminLogin"); // Replace "/admin-login" with the actual route for your admin login page
    }
  ...
  return (
    <>
      ...
      <div id="login1" className={loginstyle.login}>
        <form>
          <h1 id="loginh1">Login As FieldStaff</h1>
          <input
            type="text"
            name="username"
            id="username"
